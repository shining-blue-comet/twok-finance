...
import { erc20ABI, twokfBnbfegVaultAddress, twokfBnbLPLockTokenAddress, twokfBnbfegLpABI } from '../../contracts/twok-bnb-feglp.sol/twokfBnbfeg';

const web3 = new Web3( window.ethereum )

export const twokfBnbfegLp = {
  namespaced: true,
  state: {
    accountBalance: 0,
    ...
    lockToken: null,
    vault: null,
    vaultAddress: twokfBnbfegVaultAddress,
    checkBalances: true
  },
  mutations: {
    ...
    setLockToken( state, web3 ) {
      state.lockToken = new web3.eth.Contract( erc20ABI, twokfBnbLPLockTokenAddress );
    },

    setVault( state, web3 ) {
      state.vault = new web3.eth.Contract( twokfBnbfegLpABI, twokfBnbfegVaultAddress )
    },
