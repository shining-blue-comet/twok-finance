...
import { erc20ABI, cessLPLockTokenAddress, cessLPVaultAddress, cessLPVaultABI } from '../../contracts/cess-lp.sol/cess-lp';
...
export const cesslp = {
  ...
  state: {
    ...
    lockToken: null,
    vault: null,
    vaultAddress: cessLPVaultAddress,
    checkBalances: true
  },
  mutations: {
    ...
    setLockToken( state, web3 ) {
      state.lockToken = new web3.eth.Contract( erc20ABI, cessLPLockTokenAddress );
    },

    setVault( state, web3 ) {
      state.vault = new web3.eth.Contract( cessLPVaultABI, cessLPVaultAddress )
    },
