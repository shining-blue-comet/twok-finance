...
import { erc20ABI, twokBnbLpAddress, twokBnbLockTokenAddress, twokBnbLpABI } from '../../contracts/twok-bnb-lp.sol/twokBnbLpVault';

const web3 = new Web3( window.ethereum )

export const twokBnbLp = {
  namespaced: true,
  state: {
    accountBalance: 0,
  ...
  mutations: {
    ...
    setLockToken( state, web3 ) {
      state.lockToken = new web3.eth.Contract( erc20ABI, twokBnbLockTokenAddress );
    },

    setVault( state, web3 ) {
      state.vault = new web3.eth.Contract( twokBnbLpABI, twokBnbLpAddress )
    },
