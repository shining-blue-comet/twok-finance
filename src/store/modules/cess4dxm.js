...
import { erc20ABI, cessdxmLockTokenAddress, cessdxmVaultAddress, cessdxmVaultABI } from '../../contracts/cess-dxm.sol/cess-dxm';

const web3 = new Web3( window.ethereum )

export const cess4dxm = {
  namespaced: true,
  state: {
    accountBalance: 0,
    ...
    lockToken: null,
    vault: null,
    vaultAddress: cessdxmVaultAddress,
    checkBalances: true
  },
  mutations: {
    ...
    setLockToken( state, web3 ) {
      state.lockToken = new web3.eth.Contract( erc20ABI, cessdxmLockTokenAddress );
    },

    setVault( state, web3 ) {
      state.vault = new web3.eth.Contract( cessdxmVaultABI, cessdxmVaultAddress )
    },
