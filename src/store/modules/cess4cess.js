...
import { erc20ABI, cessLockTokenAddress, cessVaultAddress, cessVaultABI } from '../../contracts/cess-cess.sol/cess-cess';

const web3 = new Web3( window.ethereum )

export const cess4cess = {
  namespaced: true,
  state: {
    accountBalance: 0,
  ...
  mutations: {
    ...
    setLockToken( state, web3 ) {
      state.lockToken = new web3.eth.Contract( erc20ABI, cessLockTokenAddress );
    },

    setVault( state, web3 ) {
      state.vault = new web3.eth.Contract( cessVaultABI, cessVaultAddress )
    },
