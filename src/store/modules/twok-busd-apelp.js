...
import { erc20ABI, twokUSDApeLockTokenAddress, twokUSDApeVaultAddress, twokUsdApeLpABI } from '../../contracts/twok-busd-apelp.sol/twokUsdApeLp';

const web3 = new Web3( window.ethereum )

export const twokUsdApeLp = {
  namespaced: true,
  state: {
    accountBalance: 0,
    ...
    lockToken: null,
    vault: null,
    vaultAddress: twokUSDApeVaultAddress,
    checkBalances: true
  },
  mutations: {
    ...
    setLockToken( state, web3 ) {
      state.lockToken = new web3.eth.Contract( erc20ABI, twokUSDApeLockTokenAddress );
    },

    setVault( state, web3 ) {
      state.vault = new web3.eth.Contract( twokUsdApeLpABI, twokUSDApeVaultAddress )
    },
