  ...
  <section class="kk-section">
    ...
    <div class="kk-section-cont">
      <div class="dynCont left">
        <form>
          <span class="kk-h5"
            >Available DexMoon Tokens: {{ accountBalance }} </span
          >
          <input-box
        ...
        >Currently Staked: {{ currentlyStaked }} DexMoon </div>
      </div>
    </div>
  </section>
</template>
  ...
  export default {
    ...
    mounted() {
      setInterval(() => {
        ...
        this.state = this.$store.state.dxm4cess;
      }, 1200);
    },
    methods: {
      open(key) {
      ...
      async stake() {      
        ...
        setTimeout(() => {
          ...
          const daysInSeconds = BigNumber( this.lockingTime * 86400 );
