  ...
  <section class="kk-section">
    ...
    <div class="kk-section-cont">
      <div class="dynCont left">
        <form>
          <span class="kk-h5"
            >Available TWOK / fBNB LP Tokens: {{ accountBalance }} </span
          >
          <input-box
        ...
        >Currently Staked: {{ currentlyStaked }} TWOK / fBNB LP </div>
      </div>
    </div>
  </section>
</template>
  ...
  export default {
    ...
    mounted() {
      setInterval(() => {
        ...
        this.state = this.$store.state.twokfBnbfegLp;
      }, 1200);
    },
    methods: {
      open(key) {
