  ...
  <section class="kk-section">
    ...
    <div class="kk-section-cont">
      <div class="dynCont left">
        <form>
          <span class="kk-h5"
            >Available TWOK / BUSD - LP Tokens: {{ accountBalance }} </span
          >
          <input-box
        ...
        >Currently Staked: {{ currentlyStaked }} TWOK/BUSD LP APESwap </div>
      </div>
    </div>
  </section>
</template>
  ...
  export default {
    ...
    mounted() {
      setInterval(() => {
        ...
        this.state = this.$store.state.twokUsdApeLp;
      }, 1200);
    },
    methods: {
      open(key) {
